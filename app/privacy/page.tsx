...
export const metadata: Metadata = {
  ...
  title: "개인정보처리방침 | 온:음(WarmWake)",
  description:
    "온:음(돈민찌랩)이 수집, 처리, 보관하는 개인정보 항목과 이용자 권리, 안전조치, 제3자 제공 현황, 변경 고지 방식을 안내합니다.",
  openGraph: {
    title: "개인정보처리방침 | 온:음(WarmWake)",
    description:
      "온:음(돈민찌랩)이 수집, 처리, 보관하는 개인정보 항목과 이용자 권리, 안전조치, 제3자 제공 현황, 변경 고지 방식을 안내합니다.",
...
export default function PrivacyPage() {
  ...
  return (
    <PolicyLayout
      description="온:음(돈민찌랩)은 로컬 중심 알람 환경을 지향하며, 수집되는 정보와 처리 목적, 제3자 전달 현황, 이용자 권리와 안전 조치 등을 투명하게 안내합니다."
