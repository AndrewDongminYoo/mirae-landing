  ...
  return (
    ...
    >
      ...
      <div aria-hidden="true" className="pointer-events-none absolute inset-0 -z-10">
        <div className="absolute top-1/2 left-1/2 h-[500px] w-[500px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-primary/3 blur-3xl" />
      </div>
      ...
      <div className="mx-auto max-w-4xl text-center">
        ...
        <div className="mx-auto mt-12 grid max-w-3xl grid-cols-2 gap-4 sm:gap-6 lg:grid-cols-4">
          {updates.map((update) => (
            <div
              className="flex flex-col items-center rounded-2xl border border-primary/10 bg-primary/5 p-4 text-center"
              key={update.title}
            >
        ...
        {/* Version info */}
        <div className="mt-10 inline-flex items-center gap-2 rounded-full bg-muted px-4 py-2 text-sm text-muted-foreground">
