  ...
  return (
    ...
    >
      ...
      <div aria-hidden="true" className="pointer-events-none absolute inset-0 -z-10">
        <div className="absolute top-1/4 right-0 h-[400px] w-[400px] translate-x-1/2 rounded-full bg-primary/5 blur-3xl" />
        <div className="absolute bottom-1/4 left-0 h-[300px] w-[300px] -translate-x-1/2 rounded-full bg-accent/10 blur-3xl" />
      </div>
        ...
        <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-16">
          ...
          <div className="order-2 text-center lg:order-1 lg:text-left">
            ...
            <div className="mt-8 flex flex-col items-center gap-3 sm:flex-row lg:justify-start">
              <Button
                asChild
                className="h-12 gap-2 rounded-xl bg-primary px-6 font-semibold text-primary-foreground shadow-lg shadow-primary/20 hover:bg-primary/90"
                size="lg"
              >
                <Link
              ...
              <Button
                asChild
                className="h-12 gap-2 rounded-xl border-foreground/20 bg-white/60 px-6 font-semibold backdrop-blur-sm hover:bg-white/80"
                size="lg"
                variant="outline"
              >
                <Link
